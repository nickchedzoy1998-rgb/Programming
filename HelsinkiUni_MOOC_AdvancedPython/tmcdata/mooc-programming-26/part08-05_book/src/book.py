"""
Write a class named Book with the attributes name, author, genre and year, along with a constructor which assigns initial values to these attributes.
...
The genre of the book High Adventure is autobiograp
"""
