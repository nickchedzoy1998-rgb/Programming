...
To gain the second exercise point for this exercise, your application is expected to recover from erroneous user input. Any input which does not follow the specified format should produce an error message `erroneous input`, and result in yet another repeat of the loop asking for a new command.
